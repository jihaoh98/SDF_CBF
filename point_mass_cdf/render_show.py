...
class Render_Animation:
    ...
    def render(self, xt, cir_obs_list_t, terminal_time, show_obs, save_gif=False):
        """ Visualization """
        self.fig.set_size_inches(7, 6.5)
        self.fig.set_dpi(150)
        self.ax.set_aspect('equal')

        self.ax.set_xlim(-3, 3.0)
        self.ax.set_ylim(-3, 3.0)
    ...
    def animation_init(self):
        ...
        self.start_body, = plt.plot(self.robot_init_state[0], self.robot_init_state[0], color='purple', marker='*', markersize=8)
        self.end_body, = plt.plot(self.robot_target_state[0], self.robot_target_state[1], color='purple', marker='*', markersize=8)
