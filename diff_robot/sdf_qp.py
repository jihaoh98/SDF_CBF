...
class Sdf_Cbf_Clf:
    ...
    def cbf_clf_qp(self, robot_cur_state, obs_vertexes, obs_state, add_clf=True, u_ref=None):
        """
        This is a function to calculate the optimal control for the robot with respect to the any-shaped obstacle
        Args:
            robot_cur_state: [x, y] np.array(2, )
            obs_vertexes: [] list for obstacle_vertex
            obs_state: [] list for obstacle state
        Returns:
            optimal control u
        """
        if u_ref is None:
        ...
        try:
            ...
            if add_clf:
                ...
                return optimal_control, clf1, clf2, slack1, slack2, True
            else:
                return optimal_control, None, None, None, None, True
        except:
